...
if os.path.exists(OUTPATH):
    ...
    print("Output path not found, please make a sym link or directory called OUTPUT in UTIL_PROTON/scripts/demo to store output")
    sys.exit(3)
...
r = klt.pyRoot()
fout = '%s/UTIL_PROTON/DB/CUTS/run_type/coinpeak.cuts' % REPLAYPATH
