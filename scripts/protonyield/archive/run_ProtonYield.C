...
void run_ProtonYield(Int_t RunNumber = 0, Int_t MaxEvent = 0, Double_t threshold_cut = 5, Int_t pscal = 1)
{
  ...
  if(Hostname.Contains("farm")){
    rootFileNameString = Form("/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_PROTON/ROOTfilesProton/Proton_coin_replay_production_%i_%i.root",RunNumber,MaxEvent);
  }
